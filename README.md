...
Little-o requires the statement to hold for all positive constants $\ c \$. This is due to the parameter $\ \forall c > 0 \$. Big-O uses $\ \exists c > 0 \$, meaning there needs to be at least one constant for the statement to hold.
